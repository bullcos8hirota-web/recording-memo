...
const SCHEDULE: { when: string; what: string; detail: string; where: string }[] = [
  ...
  },
  {
    ...
    what: '結果を踏まえて来週を決める',
    detail:
      '売り終わったなら振り返りを書く。持ち越すなら建玉タブの「トレーリング目安」を見て、買値より上でかつ今の損切りより上ならそこまで引き上げ、SBI証券の逆指値も同じ値に出し直す。まだ買値より下なら、最初の損切りのまま動かさない。次の候補を選び直す。',
    where: 'アプリ: 記録 → 建玉 → 監視',
  },
]
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-300">
          ...
          で切られる位置になるので、最初の損切りのままにします。損切りは上げるだけで、下げません。
        </p>
